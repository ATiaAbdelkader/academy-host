...
const extraCourse43: ExtraCourse = {
  title: "Tilapia Aquaculture",
  description:
    "Complete guide to farming the world's most popular farmed fish. Learn pond management, breeding, feed formulation, water quality, harvesting, and how to build a profitable tilapia operation from backyard to commercial scale.",
  ...
  modules: [
    {
      ...
      quiz: {
        questions: [
          {
            question:
              "How long does it take tilapia fingerlings to reach 500g?",
            options: ["2-3 months", "6-8 months", "12-18 months", "2+ years"],
            correctIndex: 1,
            explanation:
              "Tilapia fingerlings reach 500g in 6-8 months under optimal conditions.",
          },
          {
            question:
              "Why is tilapia called the 'aquatic chicken'?",
            options: [
              "It tastes like chicken",
              "It's white meat",
              "It's adaptable, fast-growing, and widely farmed",
              "It's the most popular fish",
            ],
            correctIndex: 2,
            explanation:
              "Tilapia is called the 'aquatic chicken' because of its adaptability, fast growth, and widespread farming — similar to how chicken dominates poultry.",
          },
          {
            question:
              "What is the optimal water temperature range for tilapia?",
            options: ["5-10°C", "10-15°C", "16-35°C", "35-40°C"],
            correctIndex: 2,
            explanation:
              "Tilapia tolerate water temperatures from 16-35°C, with optimal growth at 25-30°C.",
          },
        ],
        passMark: 60,
      },
    },
    {
      ...
      quiz: {
        questions: [
          {
            question:
              "Why should ponds be dried and limed before stocking?",
            options: [
              "To make the water deeper",
              "To kill parasites and pathogens, and neutralize soil acidity",
              "To remove weeds",
              "To warm up the soil",
            ],
            correctIndex: 1,
            explanation:
              "Drying kills parasites/pathogens, while liming neutralizes soil acidity and improves the pond bottom environment.",
          },
          {
            question:
              "What is the recommended stocking density for earthen ponds?",
            options: ["0.5-1/m²", "3-5/m²", "20-50/m²", "100+/m²"],
            correctIndex: 1,
            explanation:
              "Earthen ponds should be stocked at 3-5 fingerlings per m². Tank systems can support higher densities (20-50/m²).",
          },
          {
            question:
              "What should dissolved oxygen levels be for tilapia ponds?",
            options: [">1 mg/L", ">4 mg/L", ">8 mg/L", ">12 mg/L"],
            correctIndex: 1,
            explanation:
              "Dissolved oxygen should be maintained above 4 mg/L for healthy tilapia. Levels below 2 mg/L can cause fish kills.",
          },
        ],
        passMark: 60,
      },
    },
    {
      ...
      quiz: {
        questions: [
          {
            question:
              "Why are male tilapia preferred for grow-out?",
            options: [
              "Males taste better",
              "Males grow 40-60% faster than females",
              "Males are easier to feed",
              "Males are more disease resistant",
            ],
            correctIndex: 1,
            explanation:
              "Male tilapia grow 40-60% faster than females, making all-male production essential for commercial efficiency.",
          },
          {
            question:
              "How long do female tilapia incubate eggs in their mouths?",
            options: ["3-5 days", "10-14 days", "21-28 days", "30-40 days"],
            correctIndex: 1,
            explanation:
              "Female tilapia are mouthbrooders that incubate eggs for 10-14 days without eating.",
          },
          {
            question:
              "What is the typical female-to-male ratio for breeding?",
            options: [
              "1 female : 5 males",
              "1 male : 2-3 females",
              "1:1 equal ratio",
            ...
            correctIndex: 1,
            explanation:
              "The recommended breeding ratio is 1 male to 2-3 females to ensure adequate fertilization.",
          },
        ],
        passMark: 60,
      },
    },
    {
      ...
      quiz: {
        questions: [
          {
            question:
              "What protein percentage should grow-out tilapia (10-500g) receive?",
            options: ["20-22%", "28-32%", "35-40%", "45-50%"],
            correctIndex: 1,
            explanation:
              "Grow-out tilapia (10-500g) require 28-32% protein in their diet for optimal growth.",
          },
          {
            question:
              "What is an optimal Feed Conversion Ratio (FCR) for tilapia?",
            options: ["0.5-0.8", "1.5-1.8", "3.0-3.5", "5.0-6.0"],
            correctIndex: 1,
            explanation:
              "An optimal FCR for tilapia is 1.5-1.8, meaning 1.5-1.8 kg of feed produces 1 kg of fish.",
          },
          {
            question:
              "How often should fry (0-1g) be fed per day?",
            options: ["1-2 times", "3-4 times", "5-8 times", "10+ times"],
            correctIndex: 2,
            explanation:
              "Fry should be fed 5-8 times daily with finely ground high-protein feed to support rapid early growth.",
          },
        ],
        passMark: 60,
      },
    },
    {
      ...
      quiz: {
        questions: [
          {
            question:
              "What dissolved oxygen level is critical for tilapia survival?",
            options: [">1 mg/L", ">4 mg/L", ">8 mg/L", ">12 mg/L"],
            correctIndex: 1,
            explanation:
              "Dissolved oxygen must be maintained above 4 mg/L. Below 2 mg/L causes surface gasping, and below 1 mg/L causes fish kills.",
          },
          {
            question:
              "What disease causes white spots on tilapia?",
            options: [
              "Aeromonas",
              "Columnaris",
            ...
            correctIndex: 2,
            explanation:
              "Ich (Ichthyophthirius) causes characteristic white spots on the body and fins of tilapia.",
          },
          {
            question:
              "What is the best way to prevent most fish diseases?",
            options: [
              "Use antibiotics regularly",
              "Maintain good water quality and proper stocking density",
              "Feed more protein",
              "Increase water temperature",
            ],
            correctIndex: 1,
            explanation:
              "The best disease prevention is maintaining good water quality, proper stocking density, and good husbandry practices.",
          },
        ],
        passMark: 60,
      },
    },
    {
      ...
      quiz: {
        questions: [
          {
            question:
              "What is the recommended market size for tilapia?",
            options: ["50-100g", "100-200g", "300-600g", "1-2kg"],
            correctIndex: 2,
            explanation:
              "Tilapia should be harvested at 300-600g for optimal market value and consumer preference.",
          },
          {
            question:
              "How should fish be handled immediately after harvest?",
            options: [
              "Leave in warm water",
              "Chill on ice immediately (0-4°C)",
            ...
            correctIndex: 1,
            explanation:
              "Fish should be chilled on ice immediately (0-4°C) after harvest to maintain quality and freshness.",
          },
          {
            question:
              "What is the expected yield from earthen ponds?",
            options: [
              "0.5-1 tons/hectare",
              "4-8 tons/hectare/cycle",
              "20-50 tons/hectare",
              "100+ tons/hectare",
            ],
            correctIndex: 1,
            explanation:
              "Earthen ponds typically yield 4-8 tons per hectare per cycle, while intensive systems can produce 20-50 tons/hectare.",
          },
        ],
        passMark: 60,
      },
