...
const extraCourse51: ExtraCourse = {
  title: "Seaweed & Algae Farming",
  description:
    "Master ocean and freshwater farming of seaweed and microalgae. Learn cultivation techniques, harvesting, processing, and how to build a profitable aquafarming business with zero freshwater or fertilizer inputs.",
  ...
  modules: [
    {
      ...
      quiz: {
        questions: [
          {
            question: "How fast can seaweed grow?",
            options: ["1-5 cm/day", "10-15 cm/day", "30-60 cm/day", "1 meter/day"],
            correctIndex: 2,
            explanation: "Seaweed can grow 30-60cm per day, making it one of the fastest-growing organisms on Earth.",
          },
          {
            question: "What is the global seaweed market size?",
            options: ["$2 billion", "$8 billion", "$16 billion", "$50 billion"],
            correctIndex: 2,
            explanation: "The global seaweed market is valued at $16 billion (2023) and growing 8-10% annually.",
          },
          {
            question: "How much freshwater does seaweed farming require?",
            options: ["Large amounts", "Moderate amounts", "Minimal", "None"],
            correctIndex: 3,
            explanation: "Seaweed farming requires zero freshwater — it grows directly in ocean water, absorbing nutrients naturally.",
          },
        ],
        passMark: 60,
      },
    },
    {
      ...
      quiz: {
        questions: [
          {
            question: "What is the most common seaweed cultivation method?",
            options: ["Floating rafts", "Off-bottom", "Longline cultivation", "Tank systems"],
            correctIndex: 2,
            explanation: "Longline cultivation is the most common method, using horizontal ropes suspended from buoys with seed ropes attached.",
          },
          {
            question: "When is the typical seaweed growing season?",
            options: ["Spring to Summer", "Summer to Fall", "Fall to Spring", "Year-round"],
            correctIndex: 2,
            explanation: "Seaweed is typically planted in fall (September-November) and harvested in spring (March-May) over 4-6 months.",
          },
          {
            question: "How often should seaweed farm lines be checked?",
            options: ["Daily", "Weekly", "Monthly", "Once per season"],
            correctIndex: 1,
            explanation: "Seaweed farm lines should be checked weekly for damage, fouling, and growth progress.",
          },
        ],
        passMark: 60,
      },
    },
    {
      ...
      quiz: {
        questions: [
          {
            question: "How much weight is reduced when seaweed is dried?",
            options: ["20-30%", "40-50%", "60-70%", "80-90%"],
            correctIndex: 3,
            explanation: "Drying reduces seaweed weight by 80-90%, making it much easier to store and transport.",
          },
          {
            question: "What is the premium processing method for seaweed?",
            options: ["Sun drying", "Freeze-drying", "Smoking", "Fermentation"],
            correctIndex: 1,
            explanation: "Freeze-drying produces the highest quality dried seaweed, preserving nutrients and color, though it's the most expensive method.",
          },
          {
            question: "How long is fresh seaweed shelf life when refrigerated?",
            options: ["1-2 days", "5-7 days", "2-3 weeks", "1-2 months"],
            correctIndex: 1,
            explanation: "Fresh seaweed has a shelf life of 5-7 days when refrigerated at 4°C.",
          },
        ],
        passMark: 60,
      },
        ...
        questions: [
          {
            ...
            options: ["20-30%", "40-50%", "60-70%", "80-90%"],
            correctIndex: 2,
            explanation: "Spirulina contains 60-70% protein, making it one of the most protein-dense foods on Earth.",
          },
          {
            question: "Which cultivation system is most cost-effective for large-scale microalgae?",
            options: ["Photobioreactors", "Open raceway ponds", "Fermentation tanks", "Aquariums"],
            correctIndex: 1,
            explanation: "Open raceway ponds are the most cost-effective at $50-100/m², though they have higher contamination risk.",
          },
          {
            question: "What is the production rate of open pond systems?",
            options: ["1-5 g/m²/day", "10-20 g/m²/day", "50-100 g/m²/day", "200+ g/m²/day"],
            correctIndex: 1,
            explanation: "Open pond systems typically produce 10-20 grams of dry biomass per square meter per day.",
          },
        ],
        passMark: 60,
      },
    },
    {
      ...
      quiz: {
        questions: [
          {
            question: "Which seaweed business model has the highest margin?",
            options: ["Raw material sales", "Value-added products", "Ingredient supply to pharma", "Agritourism"],
            correctIndex: 2,
            explanation: "Ingredient supply to pharmaceutical and cosmetic companies has the highest margin at $50-500/kg, though it requires certifications.",
          },
          {
            question: "What is the typical revenue from seaweed carbon credits?",
            options: ["$1-5/ton", "$10-30/ton", "$100-200/ton", "$500+/ton"],
            correctIndex: 1,
            explanation: "Seaweed carbon credits typically sell for $10-30 per ton of CO2 sequestered.",
          },
          {
            question: "What is the best way to market seaweed to unfamiliar consumers?",
            options: ["Lower prices", "Offer tasting samples and emphasize sustainability", "Sell only online", "Avoid consumer markets"],
            correctIndex: 1,
            explanation: "Offering tasting samples and emphasizing the sustainability story are the most effective ways to market seaweed to unfamiliar consumers.",
          },
        ],
        passMark: 60,
      },
    },
    {
      ...
      quiz: {
        questions: [
          {
            question: "What percentage of global CO2 emissions could seaweed farming potentially offset?",
            options: ["0.1%", "1%", "5%", "25%"],
            correctIndex: 2,
            explanation: "Seaweed farming has the potential to offset approximately 5% of global CO2 emissions through carbon sequestration.",
          },
          {
            question: "What is IMTA?",
            options: [
              "International Marine Technology Association",
              "Integrated Multi-Trophic Aquaculture — combining seaweed, shellfish, and finfish",
              "Indian Marine Training Academy",
              "International Maritime Transport Agreement",
            ],
            correctIndex: 1,
            explanation: "IMTA (Integrated Multi-Trophic Aquaculture) combines seaweed, shellfish, and finfish farming to create a balanced, sustainable ecosystem.",
          },
          {
            question: "How does seaweed farming help combat ocean acidification?",
            options: [
              "By adding chemicals to the water",
              "By absorbing CO2, which locally reduces ocean acidity",
              "By blocking sunlight",
              "By introducing new species",
            ],
            correctIndex: 1,
            explanation: "Seaweed absorbs CO2 during photosynthesis, which locally reduces ocean acidity and helps protect coral reefs and shellfish.",
          },
        ],
        passMark: 60,
      },
