  ...
  modules: [
    {
      ...
      content: [
        ...
        { type: "quiz", title: "Module Quiz", questions: [
          { question: "By how much does each 1°C temperature increase reduce wheat yields?", options: ["1-2%", "3-4%", "6%", "10-15%"], answerIndex: 2 },
          { question: "What is the difference between climate adaptation and mitigation?", options: ["They are the same thing", "Adaptation adjusts farming to survive changes; mitigation reduces agriculture's greenhouse gas emissions", "Mitigation is more important", "Adaptation only applies to animals"], answerIndex: 1 }
        ], passPercent: 70 }
      ]
    },
    {
      ...
      content: [
        ...
        { type: "quiz", title: "Module Quiz", questions: [
          { question: "How much faster are AI weather models compared to traditional numerical weather prediction?", options: ["2x faster", "5x faster", "10x faster", "100x faster"], answerIndex: 2 },
          { question: "Why is downscaling important for agricultural weather forecasting?", options: ["It makes forecasts cheaper", "Global models have 10-25km resolution, but farming decisions need field-level (1km or less) resolution", "It's required by regulation", "It only works for rain forecasts"], answerIndex: 1 }
        ], passPercent: 70 }
      ]
    },
    {
      ...
      content: [
        ...
        { type: "quiz", title: "Module Quiz", questions: [
          { question: "What lead time can AI drought early warning systems provide?", options: ["1-2 days", "1-2 weeks", "2-6 months", "1-2 years"], answerIndex: 2 },
          { question: "When is the optimal time to irrigate during drought conditions to minimize water loss?", options: ["Midday", "Afternoon", "Night or early morning", "Evening"], answerIndex: 2 }
        ], passPercent: 70 }
      ]
    },
    {
      ...
      content: [
        ...
        { type: "quiz", title: "Module Quiz", questions: [
          { question: "What is the Sub1 rice variety?", options: ["A fast-growing variety", "A flood-tolerant variety that survives 2 weeks submerged", "An organic variety", "A cold-tolerant variety"], answerIndex: 1 },
          { question: "How do AI flood models achieve prediction accuracy?", options: ["By tracking individual raindrops", "By combining rainfall forecasts, terrain analysis, soil saturation, and river levels with ML algorithms", "By counting clouds", "By measuring wind speed only"], answerIndex: 1 }
        ], passPercent: 70 }
      ]
    },
    {
      ...
      content: [
        ...
        { type: "quiz", title: "Module Quiz", questions: [
          { question: "How much can overhead irrigation reduce canopy temperature during heat events?", options: ["1-2°C", "3-4°C", "5-8°C", "15-20°C"], answerIndex: 2 },
          { question: "Why do high nighttime temperatures reduce grain fill?", options: ["They prevent pollination", "Increased respiration at night consumes stored carbohydrates that would go to grain", "They attract pests", "They reduce soil moisture"], answerIndex: 1 }
        ], passPercent: 70 }
      ]
    },
    {
      ...
      content: [
        ...
        { type: "quiz", title: "Module Quiz", questions: [
          { question: "What are the three pillars of Climate-Smart Agriculture (CSA)?", options: ["Profit, productivity, popularity", "Increase productivity, enhance resilience, reduce emissions", "Soil, water, air", "Seeds, fertilizer, water"], answerIndex: 1 },
          { question: "How much can carbon credits earn farmers through climate-smart practices?", options: ["$1-5/ton", "$10-15/ton", "$20-50/ton CO₂e", "$100+/ton"], answerIndex: 2 }
        ], passPercent: 70 }
      ]
    }
  ]
