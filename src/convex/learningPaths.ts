...
const LEARNING_PATHS = [
  ...
  },
  {
    ...
    description: "Explore precision agriculture, IoT in farming, ML crop recommendation, plant disease detection, and the AgroAI smart agriculture ecosystem.",
    icon: "🤖",
    color: "term-green",
    courseSlugs: [
      ...
      "farm-automation",
      "data-driven-farming",
      "iot-soil-sensing-smart-data-collection",
      "ai-crop-recommendation-systems",
      "plant-disease-detection-with-deep-learning",
      "smart-agriculture-system-architecture",
      "machine-learning-pipeline-for-agriculture",
    ],
    estimatedWeeks: 20,
    difficulty: "advanced",
  },
